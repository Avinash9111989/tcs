...
<body data-spy="scroll" data-target="#footer">
	...
	<br>
	<br>
	<div style="font-weight: 600; text-align: center;" class="fontstyle">
		Sorry! Registration is unsuccessful
		<h5>
			Click <a href="register.jsp">here</a> to register again
		</h5>
	</div>

	<!-- SLIDER -->
	<section id="slider" class="margintop-10" style="margin-top: 40px;">
				...
				<div class="item active"
					...
					<div class="container">
						<div class="col-sm-6">
							...
							<p class="carousel-content  " style="color: white">Taking
								more than one flight to get to your final destination? At
								InfyGo, we make connecting flights much easier!</p>
						</div>
					</div>
				</div>
				<div class="item"
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-sm-pull-6 padding-15">
					<p>
						&copy; 2017 <a href="${pageContext.servletContext.contextPath}">InfyGo</a>.
						All Rights Reserved.
					</p>
				</div>
			</div>
